...
describe('AZTEC bilateral swap verifier tests', () => {
    describe('success states', () => {
        ...
        beforeEach(() => {
            testNotes = bilateralProof.helpers.makeTestNotes([10, 20], [10, 20]);
        ...
        it('validate that the kbar relations are satisfied i.e. kbar1 = kbar3 and kbar2 = kbar4', () => {
            const { proofData, challenge } = bilateralProof.constructBilateralSwap(testNotes, sender);
            const proofDataBn = bilateralProof.helpers.toBnAndAppendPoints(proofData);
            ...
            const { recoveredBlindingFactors } = bilateralProof.helpers.recoverBlindingFactorsAndChallenge(proofDataBn,
                formattedChallenge,
                finalHash);
    ...
    describe('failure states', () => {
        ...
        it('will REJECT for random note values', () => {
            const randomNotes = bilateralProof.helpers.makeTestNotes(
        ...
        it('will REJECT if bilateral swap note balancing relationship not satisfied', () => {
            const unbalancedNotes = bilateralProof.helpers.makeTestNotes([10, 19], [10, 20]); // k_2 != k_4
